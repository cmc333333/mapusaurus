...
from hmda.management.commands.calculate_loan_stats import (
     calculate_median_loans, calculate_lar_count, calculate_fha_count,
     get_fha_bucket,
)
...
class PrecalcTest(TestCase):
    ...
    def setUp(self):
        self.respondent = Institution.objects.get(pk="1970922-333")
        tract_params = {
        ...
        self.metro = Geo.objects.create(
            ...
            geoid='201399999',
            cbsa='99999',
            geo_type=Geo.METRO_TYPE,
            **tract_params,
        )

        hmda_params = {
            'as_of_year': 2013,
            'respondent_id': self.respondent.respondent_id,
            'agency_code': str(self.respondent.agency_id),
            'property_type': 1,
            'loan_purpose': 1,
            'owner_occupancy': 1,
            'loan_amount_000s': 100,
            'preapproval': '1',
            'action_taken': 1,
            'msamd': '01234',
            'statefp': '11',
        ...
        self.inst1 = Institution.objects.create(
            year=2013,
            respondent_id='9876543210',
            agency=Agency.objects.get(pk=9),
            institution_id='99876543210',
            tax_id='1111111111',
            name='Institution',
    ...
    def test_saves_stats(self):
        ...
        for stats in LendingStats.objects.all():
            if (stats.geo_id == '201399999'
                    and stats.institution_id == lender_id):
                found = True
