...
function drawCircle(geo, options) {
    ...
    circle.tractid = geo.tractid || "", circle.volume = geo.volume, circle.type = "tract-circle", 
    circle.keyCircle = 0, void 0 !== options && (circle.keyCircle = options.keyCircle), 
...
function getRange(data) {
    ...
    if (0 === _.filter(data, circles).length) return valArray = [];
