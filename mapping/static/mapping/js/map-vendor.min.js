...
(function() {
    ...
    _.iteratee = function(value, context, argCount) {
        ...
        if (length === +length) for (i = 0; i < length; i++) iteratee(obj[i], i, obj); else {
            var keys = _.keys(obj);
        ...
        for (var currentKey, keys = obj.length !== +obj.length && _.keys(obj), length = (keys || obj).length, results = Array(length), index = 0; index < length; index++) currentKey = keys ? keys[index] : index, 
    ...
    _.reduce = _.foldl = _.inject = function(obj, iteratee, memo, context) {
        ...
        for (index = 0; index < length; index++) if (currentKey = keys ? keys[index] : index, 
        ...
        for (var rand, set = obj && obj.length === +obj.length ? obj : _.values(obj), length = set.length, shuffled = Array(length), index = 0; index < length; index++) rand = _.random(0, index), 
    ...
    _.flatten = function(array, shallow) {
        ...
        for ("number" == typeof from && (idx = from < 0 ? idx + from + 1 : Math.min(idx, from + 1)); --idx >= 0; ) if (array[idx] === item) return idx;
        return -1;
    ...
    _.bind = function(func, context) {
        ...
        return function() {
            ...
            return context = this, args = arguments, remaining <= 0 || remaining > wait ? (clearTimeout(timeout), 
        ...
        if (_.isFunction(iteratee)) {
            ...
            obj = new Object(obj);
            for (var i = 0, length = keys.length; i < length; i++) (key = keys[i]) in obj && (result[key] = obj[key]);
        }
        return result;
    ...
    o.Class = function() {}, o.Class.extend = function(t) {
        ...
        _off: function(t, e, i) {
            ...
            if (n) {
                ...
                if (d) c = o.stamp(e) + "_" + d, (a = n[s]) && a[c] && (u = a[c], delete a[c], n[r]--); else if (a = n[t]) for (h = 0, 
                l = a.length; l > h; h++) if (a[h].fn === e) {
                    u = a[h], a.splice(h, 1);
                    break;
                }
    ...
    o.Mixin = {
        ...
        getScaleZoom: function(t, e) {
            return (e = e === i ? this._zoom : e) + Math.log(t) / Math.LN2;
        },
        ...
        createIcon: function(t) {
            ...
            return i.innerHTML = !1 !== n.html ? n.html : "", n.bgPos && (i.style.backgroundPosition = -n.bgPos.x + "px " + -n.bgPos.y + "px"), 
        ...
        _simplifyDPStep: function(t, e, i, n, o) {
            var s, r, a, h = 0;
            for (r = n + 1; o - 1 >= r; r++) (a = this._sqClosestPointOnSegment(t[r], t[n], t[o], !0)) > h && (s = r, 
            h = a);
        ...
        _clipPoints: function() {
            ...
            e = 0, s = a.length; s - 1 > e; e++) (r = o.LineUtil.clipSegment(a[e], a[e + 1], l, e, !0)) && (h[i] = h[i] || [], 
            h[i].push(r[0]), (r[1] !== a[e + 1] || e === s - 2) && (h[i].push(r[1]), i++));
        },
    ...
    o.Map.mergeOptions({
        ...
        _onMouseDown: function(t) {
            return !(!t.shiftKey || 1 !== t.which && 0 !== t.button) && (this._moved = !1, o.DomUtil.disableTextSelection(), 
            o.DomUtil.disableImageDrag(), this._startPoint = this._map.mouseEventToContainerPoint(t), 
        ...
        _addItem: function(t) {
            ...
            return r.innerHTML = " " + t.name, n.appendChild(i), n.appendChild(r), (t.overlay ? this._overlaysList : this._baseLayersList).appendChild(n), 
            n;
        },
        ...
        setView: function(t, e, n) {
            ...
            n = n || {}, this.stop(), this._loaded && !n.reset && !0 !== n) {
    ...
    L.Hash = function(map) {
        ...
        var params = getHashParams();
        if (void 0 !== params.zoom || void 0 !== params.lat || void 0 !== params.lon) {
    ...
    _initLayout: function() {
        ...
        this.options.position = "n", y_bound - this._map.latLngToContainerPoint(this._latlng).y > 0 && (this.options.position = "s");
        var x_diff = this._map.latLngToContainerPoint(this._latlng).x - (this._map.getSize().x - x_bound);
        x_diff > 0 ? this.options.position += "w" : (x_diff = x_bound - this._map.latLngToContainerPoint(this._latlng).x) > 0 && (this.options.position += "e"), 
    ...
    function c(a, b, c) {
        return b.indexOf("$") > -1 ? e(a, b, c) : b.indexOf("%") > -1 ? f(a, b, c) : b.indexOf(":") > -1 ? g(a, b) : i(a._value, b, c);
    }
    function d(a, b) {
        ...
        if (b.indexOf(":") > -1) a._value = h(b); else if (b === q) a._value = 0; else {
            ...
            g = 0; g <= j.length && !(k = b.indexOf(j[g]) > -1 && Math.pow(1024, g + 1)); g++) ;
            a._value = (k || 1) * (i.match(c) ? Math.pow(10, 3) : 1) * (i.match(d) ? Math.pow(10, 6) : 1) * (i.match(e) ? Math.pow(10, 9) : 1) * (i.match(f) ? Math.pow(10, 12) : 1) * (b.indexOf("%") > -1 ? .01 : 1) * ((b.split("-").length + Math.min(b.split("(").length - 1, b.split(")").length - 1)) % 2 ? 1 : -1) * Number(b.replace(/[^0-9\.]+/g, "")), 
    ...
    function i(a, c, d) {
        ...
        0 === c.indexOf(".") && (h = ""), (k && B ? "(" : "") + (!k && B ? "-" : "") + (!B && l ? "+" : "") + h + A + (x || "") + (n || "") + (w || "") + (k && B ? ")" : "");
    }
    function j(a, b) {
        o[a] = b;
    }
    ...
    var m, o = {}, p = "en", q = null, r = "0,0", s = "undefined" != typeof module && module.exports;
    m = function(b) {
        return m.isNumeral(b) ? b = b.value() : 0 === b || void 0 === b ? b = 0 : Number(b) || (b = m.fn.unformat(b)), 
        new a(Number(b));
    }, m.version = "1.5.3", m.isNumeral = function(b) {
        ...
        format: function(a, b) {
            return c(this, a || r, void 0 !== b ? b : Math.round);
        },
        unformat: function(a) {
            return "[object Number]" === Object.prototype.toString.call(a) ? a : d(this, a || r);
        },
        value: function() {
            return this._value;
        },
    ...
    void 0 !== window && window.L && (window.L.Control.MiniMap = factory(L), window.L.control.minimap = function(layer, options) {
